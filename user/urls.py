...
from .views import TestJWTAuth, UserProfileEditView
from .views import UserProfileView, CustomRegisterView, CustomLoginView, CustomLogoutView, AddFriendView, FriendProfileView, DeleteFriendView, SearchFriendsView,  UserFriendView, CustomTokenRefreshView
